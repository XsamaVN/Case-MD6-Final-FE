                            ...
                            >
                                {({isSubmitting}) => (
                                    <Form>
                                        ...
                                        <div className="tab-content pt-4 register-body">
                                            <div role="tabpanel"
                                                            ...
                                                            <div className="col-md-6">
                                                                <div className="mb-3">
                                                                    ...
                                                                    <Field type="text" name="company_name"
                                                                           id="companyName" className="form-control"/>
                                                                    <ErrorMessage
                                                                        name="company_name"
                                                                        component="div"
                                                                        className="text-danger"
                                                                ...
                                                                <div className="mb-3">
                                                                    ...
                                                                    <Field type="email" name="email"
                                                                           id="companyEmail" className="form-control"/>
                                                                    <ErrorMessage
                                                                        name="email"
                                                                        component="div"
                                                                        className="text-danger"
                                                                ...
                                                                <div className="mb-3">
                                                                    ...
                                                                    <Field type="text" name="branch"
                                                                           id="companyBranch" className="form-control"/>
                                                                    <ErrorMessage
                                                                        name="branch"
                                                                        component="div"
                                                                        className="text-danger"
                                                            ...
                                                            <div className="col-md-6">
                                                                ...
                                                                <div className="mb-3">
                                                                    ...
                                                                    <Field type="text" name="phone"
                                                                           id="companyPhone" className="form-control"/>
                                                                    <ErrorMessage
                                                                        name="phone"
                                                                        component="div"
                                                                        className="text-danger"
